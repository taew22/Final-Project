    ...
    <br>
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          <label>Auther:</label> 
          <input type="text" class="form-control" v-model="blog.category" required/>
        </div>

        <div class="form-group col-md-6">
          <label>Set date:</label> 
          <input type="text" class="form-control" v-model="blog.status" required/>
        </div>
      </div>
