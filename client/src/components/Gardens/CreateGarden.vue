<template>
  <div>
    ...
    <form v-on:submit.prevent="createGarden">
      <div class="form-group">
        <label>Title :</label>
        <input type="text" class="form-control" v-model="garden.title" required/>
      </div>

      <div class="form-row">
        <div class="form-group col-md-6">
          <label>Garden type :</label>
          <select v-model="garden.status" class="form-control" required>
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" v-model="garden.category" required/>
        </div>
      </div>
...
export default {
  ...
  methods: {
    async createGarden() {
      try {
        this.garden.pictures = JSON.stringify(this.pictures); //ดูรายละเอียด
        await GardenService.post(this.garden);
        this.$router.push({
          name: "gardens"
        });
      } catch (err) {
